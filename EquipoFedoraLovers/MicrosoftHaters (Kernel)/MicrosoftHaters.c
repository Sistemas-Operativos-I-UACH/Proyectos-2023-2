...
static int __init MicrosoftHaters_init(void) {
    //int result;
    ...
    printk(KERN_INFO "MicrosoftHaters Module has been loaded\n");
...
static void __exit MicrosoftHaters_exit(void) {
    printk(KERN_INFO "Aún no hay Hate a Microsoft, removiendo módulo!!\n");
}


module_init(MicrosoftHaters_init);
module_exit(MicrosoftHaters_exit);
