...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Martin Chacon");
MODULE_DESCRIPTION("Module Chingon");
MODULE_VERSION("0.01");
...
static int __init chingon_init(void) {
    //int result;
...
static void __exit chingon_exit(void) {
    printk(KERN_INFO "No esta tan chingon, removiendo módulo!!\n");
}


module_init(chingon_init);
module_exit(chingon_exit);