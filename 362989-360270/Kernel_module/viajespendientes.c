...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("360270-362989");
MODULE_DESCRIPTION("Module for viajes pendientes!");
MODULE_VERSION("0.01");
...
static int __init viajespendientes_init(void) {
    //int result;
    ...
    printk(KERN_INFO "viajespendientes Module has been loaded\n");
...
static void __exit viajes_exit(void) {
    printk(KERN_INFO "Aún no hay viajes pendientes, removiendo módulo!!\n");
}


module_init(viajespendientes_init);
module_exit(viajespendientes_exit);
